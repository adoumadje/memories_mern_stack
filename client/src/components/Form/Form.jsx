  ...
  return (
    <Paper sx={styles.paper}>
      <form autoComplete='off' noValidate style={{...styles.form}} onSubmit={handleSubmit}>
        ...
        />
        <TextField sx={{marginBottom: 2}} name='title' variant='outlined' label='Title' fullWidth value={postData.title} 
          onChange={(e) => setPostData({ ...postData, title: e.target.value })}
        />
        <TextField sx={{marginBottom: 2}} name='message' variant='outlined' label='Message' fullWidth value={postData.message} 
